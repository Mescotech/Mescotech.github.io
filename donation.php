...
<body>
    <div class="header">
        ...
        <a href="mailto:kicunguroangelcentre@gmail.com "> <p>kicunguroangelcentre@gmail.com </p></a>
</div>
<div class="hero">
    <div class="menu">
        <a href="index.html"><span id="dp"><img src="care.jpg"></span></a>
        <a href="index.html"><p id="menu">Home</p></a>
        <a href="services.html"><p id="menu">Services</p></a>
        <a href="reachus.html"><p id="menu">Reach us</p></a>
        <a href="donate.html"><p><button id="donate">DONATE</button></p></a>
    ...
    <div class="flex">
        ...
        <div class="form">
            <form class="" action="" method="post">
                ...
                <input type="number" name="amout" placeholder="Enter Donation Amount">
    ...
    <div class="footer">
        ...
        <table>
            ...
            <td><a href="mailto:kicunguroangelcentre@gmail.com ">kicunguroangelcentre@gmail.com </a></td>
            <td><a href="index.html">Facebook</a></td>
        </tr>
        <tr>
            <td><a href="services.html">Services</a></td>
            <td><a href="mailto:aherezronaldscott@gmail.com">Email Us</a></td>
            <td><a href="mailto:davidkabigumira@gmail.com">davidkabigumira@gmail.com</a></td>
            <td><a href="index.html">Twitter</a></td>
        </tr>
        <tr>
            <td><a href="reachus.html">Reach us</a></td>
            <td><a href="index.html"></a></td>
            <td><a href="mailto:jollyk2015@gmail.com ">jollyk2015@gmail.com </a></td>
        ...
        <tr>
            ...
            <td><a href="index.html"></a></td>
            <td><a href="index.html"></a></td>
            <td><a href="index.html">Instagram</a></td>
        </tr>
